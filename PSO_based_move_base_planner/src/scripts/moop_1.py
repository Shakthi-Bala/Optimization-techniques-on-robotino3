...
class MOEPSONode:
    ...
    def run_moepso(self):
        ...
        # Publish optimized path here using self.path_publisher
        # You need to loop through self.moepso.particles and add points to the path
        ...
        # Publish best fitness here using self.best_fitness_publisher
        best_fitness_msg = Float64()
        best_fitness_msg.data = self.moepso.best_fitness
        self.best_fitness_publisher.publish(best_fitness_msg)
